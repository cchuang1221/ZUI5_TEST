		...
		onTheMasterPage: {
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "YEGUI0004_STRSet (0)"
						}),
						success: function() {
							Opa5.assert.ok(true, "The list header displays 'YEGUI0004_STRSet (0)'");
						},
				...
				theListShouldHaveAllEntries: function() {
					...
					// retrieve all YEGUI0004_STRSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "YEGUI0004_STRSet (" + iExpectedLength + ")"
								}),
								success: function() {
